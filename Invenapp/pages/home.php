          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">Welcome, <?= $user ?>!</h2>
                </div>
                <div class="col-auto">
                  ...
                  <div class="card-body">
                    <div class="row mt-1 align-items-center">
                      <div class="col-12 col-lg-4 text-left pl-4">
                        <p class="mb-1 small text-muted">SELAMAT DATANG DI APLIKASI</p>
                        <span class="h3">Inventaris Laboratorium</span>
                        <p class="text-muted mt-2">Selamat Beraktivitas <?= $user ?>!</p>
                      </div>
                  </div> <!-- .card-body -->
                </div> <!-- .card -->
              </div>
