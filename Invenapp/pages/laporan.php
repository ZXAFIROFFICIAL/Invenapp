...
@keyframes slideDownFade {
  ...
  <body class="vertical  light  ">
    ...
    <div class="panel panel-primary">
        <center><h2>Laporan Peminjaman Inventaris</h2></center><hr>
        <div class="panel-body">
            <form action="" class="form-inline">
                <input type="hidden" name="p" value="laporan">
                <div class="form-group" style="margin-bottom: 1rem;">
                    <label for="">Tanggal Awal</label>
                    <input style="margin-left: 1rem;" type="date" id="tgl_awal" name="tglDari" class="form-control" value=" <?= !empty($_GET['tglDari']) ? $_GET['tglDari'] : $hari_ini?>">
                </div>
                <div class="form-group" style="margin-bottom: 1rem; margin-left: 1rem;">
                    <label for="">Tanggal Sampai</label><br>
                    <input style="margin-left: 1rem;" type="date" id="tgl_sampai" name="tglSampai" class="form-control" value=" <?= !empty($_GET['tglSampai']) ? $_GET['tglSampai'] : $hari_ini?>">
                </div>
